...
// Export POST with QStash signature verification
export const POST = verifySignatureAppRouter(handleScrapeRequest);

// Health check endpoint (no verification needed)
